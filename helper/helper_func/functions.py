...
def prompt_for_action():
    ...
    print("1. Clean eligibility and config files off device")
    print("2. Apply eligibility and config patches")
    print("3. Clean Files and apply patches")
    print("4. Automated spam method")
    print("5. Automated spam theory(with cleaning)")
